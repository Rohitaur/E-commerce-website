        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <Rating name="disabled" value={4.5} readOnly />
              <p className="opacity-50 text-sm">56540 Ratings</p>
              <p className="mi-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">3870 Reviews</p>
               </div>
              </div>
              ...
              <form className="mt-10">
               ...
               <Button onClick={handleAddToCard} className="bg-red-700 px-2 py-1" variant="contained">
                Add To Cart
               </Button>
